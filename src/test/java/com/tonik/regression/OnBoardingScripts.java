...
public class OnBoardingScripts extends BaseTest{
    ...
    @Test(priority = 9)
    public void TBD_OB_022() throws Exception {
        try {
            onboardingModule.autoPopulatedPassportDetailsValidation_TBD_OB_022();
        } catch (AssertionError | Exception e) {
            throw e;
        } finally {
            softAssert.assertAll();
    ...
    @Test(priority = 14)
    public void TBD_OB_027() throws Exception {
        try {
            onboardingModule.autoPopulatedPhilippinesCountryValidation_TBD_OB_027();
        } catch (AssertionError | Exception e) {
            throw e;
        } finally {
            softAssert.assertAll();
    ...
    public void TBD_OB_030() throws Exception {
        try {
            onboardingModule.validZipCodeDetailsValidation_TBD_OB_030();
        } catch (AssertionError | Exception e) {
            throw e;
        } finally {
            softAssert.assertAll();
    ...
    @Test(priority = 18)
    public void TBD_OB_031() throws Exception {
        try {
            onboardingModule.applyZipCodeButtonValidation_TBD_OB_031();
        } catch (AssertionError | Exception e) {
            throw e;
        } finally {
            softAssert.assertAll();
    ...
    @Test(priority = 28)
    public void TBD_OB_043() throws Exception {
        try {
            onboardingModule.inputInvalidEmailValidation_TBD_OB_043();
        } catch (AssertionError | Exception e) {
            throw e;
        } finally {
            softAssert.assertAll();
    ...
    @Test(priority = 29)
    public void TBD_OB_044() throws Exception {
        try {
            onboardingModule.leaveEmailAddressAndCorrespondingErrorValidation_TBD_OB_044();
        } catch (AssertionError | Exception e) {
            throw e;
        } finally {
            softAssert.assertAll();
    ...
    @Test(priority = 30)
    public void TBD_OB_045() throws Exception {
        try {
            onboardingModule.validEmailAddressValidation_TBD_OB_045();
        } catch (AssertionError | Exception e) {
            throw e;
        } finally {
            softAssert.assertAll();
    ...
    public void TBD_OB_047() throws Exception {
        try {
            onboardingModule.invalidMotherMaidenNameValidation_TBD_OB_047();
        } catch (AssertionError | Exception e) {
            throw e;
        } finally {
            softAssert.assertAll();
    ...
    @Test(priority = 33)
    public void TBD_OB_048() throws Exception {
        try {
            onboardingModule.leaveMotherMaidenNameAndCorrespondingErrorValidation_TBD_OB_048();
        } catch (AssertionError | Exception e) {
            throw e;
        } finally {
            softAssert.assertAll();
    ...
    @Test(priority = 43)
    public void TBD_OB_065_BD_OB_057() throws Exception {
        try {

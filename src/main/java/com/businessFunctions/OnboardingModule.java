...
//            waitForElementToBePresent(OnBoardingPage.objWelcomeScreen2Btn,5,"WelcomeScreen2Btn");
        ...
        if(verifyElementDisplayed(LoginPage.objTakePicturePermission)){
            verifyElementPresent(LoginPage.objTakePicturePermission,getTextVal(LoginPage.objTakePicturePermission,": Take Picture Permission popup"));
    ...
    public void createTonikAccountPageUIValidation() throws Exception {
        ...
        if (verifyElementDisplayed(OnBoardingPage.objCreateAccountPage)) {
            ...
            assertionValidation(getText(LoginPage.objPageTitle), propertyFileReader("CreateAccountPageTitle","onboarding"),": Page Title");
            verifyElementPresent(LoginPage.objPageSubTitle,getTextVal(LoginPage.objPageSubTitle,": Page Subtitle"));
            assertionValidation(getText(LoginPage.objPageSubTitle), propertyFileReader("CreatePageAccountSubtitle","onboarding"),": page Subtitle");
            ...
            verifyElementPresent(LoginPage.objNextBtn,getTextVal(OnBoardingPage.objNextBtn,": Button"));
            verifyElementPresent(OnBoardingPage.objCustomerCareIcon,"Customer care icon");
        }
    }
    ...
    public void customerCareIconValidation() throws Exception {
        ...
        contactUsPageUI();
        click(LoginPage.objBackBtn,"Get in touch back button");
    }
    ...
    public void enterOTP() throws Exception {
        ...
        if(verifyElementDisplayed(OnBoardingPage.objEnterOTP)) {
            ...
            assertionValidation(getText(LoginPage.objPageTitle), propertyFileReader("EnterOTP", "onboarding"), ": Title");
            String OTP = generateRandomOTP();
            Actions a = new Actions(DriverManager.getAppiumDriver());
            click(OnBoardingPage.objOTPInputField(1), "OTP Input field");
            a.sendKeys("(//android.widget.TextView[contains(@text,'We sent')]/parent::android.view.ViewGroup/parent::*/following-sibling::android.view.ViewGroup/child::*/child::android.widget.TextView)[1]", OTP).perform();
    ...
    public void selectIDAndScan(By selectId) throws Exception {
        if(verifyElementDisplayed(OnBoardingPage.objIDSelectionPageTile)){
            verifyElementPresent(LoginPage.objPageTitle,getTextVal(ContactUsPage.objPageHeader," : Page Title"));
            containsValidation(getText(LoginPage.objPageTitle),propertyFileReader("IDSelectionPageTile","onboarding"),": Title");
            ...
            verifyElementPresent(LoginPage.objPageTitle,getTextVal(ContactUsPage.objPageHeader," : Page Title"));
            assertionValidation(getText(LoginPage.objPageTitle),propertyFileReader("GotAClearScan","onboarding"),": Title");
            ...
            verifyElementPresent(LoginPage.objPageTitle,getTextVal(ContactUsPage.objPageHeader," : Page Title"));
            assertionValidation(getText(LoginPage.objPageTitle),propertyFileReader("DidWeGetItRightTitle","onboarding"),": Title");
    ...
    public void updateSignatureAndNext() throws Exception {
        ...
        containsValidation(getText(LoginPage.objPageTitle), propertyFileReader("LetsSealTheDealPage", "onboarding"), ": Title");
        verifyElementPresent(LoginPage.objPageSubTitle,getTextVal(LoginPage.objPageSubTitle,": Page Subtitle"));
        assertionValidation(getText(LoginPage.objPageSubTitle), propertyFileReader("LetsSealTheDealPageSubtitle","onboarding"),": page Subtitle");
        updateSignature();
    ...
    public void applyZipCode(String zipCode) throws Exception {
        ...
        verifyElementPresent(LoginPage.objPageTitle,getTextVal(ContactUsPage.objPageHeader," : Page Title"));
        assertionValidation(getText(LoginPage.objPageTitle),propertyFileReader("YourPlaceRightPage","onboarding"),": Title");
     ...
     * @throws Exception
     */
    public void selectUSCitizenOrNotAndNext(By locator) throws Exception {
        if (verifyElementPresent(OnBoardingPage.objFATCAPageTitle, getTextVal(OnBoardingPage.objFATCAPageTitle, ": title"))) {
            assertionValidation(getText(LoginPage.objPageTitle), propertyFileReader("FATCAPageTitle", "onboarding"), ": Title");
            verifyElementPresentAndClick(locator, getTextVal(locator, ": option"));
            verifyElementPresentAndClick(OnBoardingPage.objNextBtn,getTextVal(OnBoardingPage.objNextBtn,": button"));
        }
    }
    /**
    ...
    public void loginStepsValidation() throws Exception {
        if(verifyElementDisplayed(OnBoardingPage.objHowToLoginPage)){
            verifyElementPresent(LoginPage.objPageTitle,getTextVal(LoginPage.objPageTitle," : Page Title"));
            assertionValidation(getText(LoginPage.objPageTitle),propertyFileReader("HowToLoginPage","onboarding"),": Title");
    ...
    public void createPasswordAndContinue() throws Exception {
        ...
        if(verifyElementDisplayed(OnBoardingPage.objPasswordField)) {
    ...
    public void barrowScreenUIValidation() throws Exception {
    ...
    public void loanScreenUIValidation() throws Exception {
        if(verifyElementDisplayed(OnBoardingPage.objBorrowScreenTitle)){
            verifyElementPresent(OnBoardingPage.objBorrowScreenTitle,getTextVal(OnBoardingPage.objBorrowScreenTitle,": Page Title"));
            for(int header=1;header<=3;header++){
                assertionValidation(getText(OnBoardingPage.objTileHeader(header)), propertyFileReader("TileHeader"+header,"onboarding"), ": Header "+header);
    ...
    public void updateEmailMotherNameAndBankingRelationShip() throws Exception {
        waitForElementToBePresent(OnBoardingPage.objCoupleMoreThinsPage,5,"Couple more things page");
        verifyElementPresent(LoginPage.objPageTitle,getTextVal(LoginPage.objPageTitle,": title"));
        assertionValidation(getText(LoginPage.objPageTitle), propertyFileReader("CoupleMoreThinsTitle", "onboarding"), ": Title");
...
//==================================== Test methods ==============================================================//
    ...
    public void openTonikApp_TBD_OB_001() throws Exception {
        ...
        handlePopup();
        waitUntilElementVisible_NoCustomMessage(OnBoardingPage.objWelcomeScreen1);
        //Screen1
        verifyElementPresent(OnBoardingPage.objWelcomeScreen1, getTextVal(OnBoardingPage.objWelcomeScreen1, ": Onboarding Screen 1"));
        assertionValidation(getText(OnBoardingPage.objWelcomeScreen1), propertyFileReader("WelcomeScreen1Msg","onboarding"),": Welcome screen 1 message");
        containsValidation(getText(OnBoardingPage.objWelcomeScreen1Btn), propertyFileReader("WelcomeScreen1Button","onboarding"),"Welcome screen 1 button");
        click(OnBoardingPage.objWelcomeScreen1Btn, getTextVal(OnBoardingPage.objWelcomeScreen1Btn, ": Onboarding Screen 1 button"));
        //Screen2
        waitTime(5000);
        verifyElementPresent(OnBoardingPage.objWelcomeScreen2, getTextVal(OnBoardingPage.objWelcomeScreen2, ": Onboarding Screen 2"));
        assertionValidation(getText(OnBoardingPage.objWelcomeScreen2), propertyFileReader("WelcomeScreen2Msg","onboarding"),": Welcome screen 2 message");
        assertionValidation(getText(OnBoardingPage.objWelcomeScreen2Btn), propertyFileReader("WelcomeScreen2Button","onboarding"),": Welcome screen 2 button");
        click(OnBoardingPage.objWelcomeScreen2Btn, getTextVal(OnBoardingPage.objWelcomeScreen2Btn, ": Onboarding Screen 2 button"));
        //Screen3
        verifyElementPresent(OnBoardingPage.objWelcomeScreen3, getTextVal(OnBoardingPage.objWelcomeScreen3, ": Onboarding Screen 3"));
        assertionValidation(getText(OnBoardingPage.objWelcomeScreen3), propertyFileReader("WelcomeScreen3Msg","onboarding"),": Welcome screen 3 message");
        assertionValidation(getText(OnBoardingPage.objWelcomeScreen3Btn), propertyFileReader("WelcomeScreen3Button","onboarding"),": Welcome screen 3 button");
        click(OnBoardingPage.objWelcomeScreen3Btn, getTextVal(OnBoardingPage.objWelcomeScreen3Btn, ": Onboarding Screen 3 button"));
        //Screen4
        verifyElementPresent(OnBoardingPage.objWelcomeScreen4, getTextVal(OnBoardingPage.objWelcomeScreen4, ": Onboarding Screen 4"));
        containsValidation(getText(OnBoardingPage.objWelcomeScreen4), propertyFileReader("WelcomeScreen4Msg","onboarding"),"Welcome screen 4 message");
        assertionValidation(getText(OnBoardingPage.objWelcomeScreen4Btn), propertyFileReader("WelcomeScreen4Button","onboarding"),": Welcome screen 4 button");
        click(OnBoardingPage.objWelcomeScreen4Btn, getTextVal(OnBoardingPage.objWelcomeScreen4Btn, ": Onboarding Screen 4 button"));
        //Screen5
        verifyElementPresent(OnBoardingPage.objWelcomeScreen5, getTextVal(OnBoardingPage.objWelcomeScreen5, ": Onboarding Screen 5"));
        containsValidation(getText(OnBoardingPage.objWelcomeScreen5), propertyFileReader("WelcomeScreen5Msg","onboarding"),"Welcome screen 5 message");
        containsValidation(getText(OnBoardingPage.objWelcomeScreen5Btn), propertyFileReader("WelcomeScreen5Button","onboarding"),"Welcome Screen 5 button");
        click(OnBoardingPage.objWelcomeScreen5Btn, getTextVal(OnBoardingPage.objWelcomeScreen5Btn, ": Onboarding Screen 5 button"));
        if(verifyElementDisplayed(LoginPage.objTakePicturePermission)){
            verifyElementPresentAndClick(LoginPage.objWhileUsingApp,getTextVal(LoginPage.objWhileUsingApp,": Button"));
        }
        ...
        if(verifyElementPresent(LoginPage.objPageTitle,getTextVal(ContactUsPage.objPageHeader," ; Page Header"))){
            assertionValidation(getText(LoginPage.objPageTitle),propertyFileReader("CreateAccountPageTitle","onboarding"),": Create Account page title");
    ...
    public void createTonikAccountUsingValidMobileNumber_TBD_OB_003() throws Exception {
        ...
        String sNextBtnEnableAttributeValue = getAttributValue("enabled",LoginPage.objNextButton);
        System.out.println(sNextBtnEnableAttributeValue);
    ...
    public void termsAndConditionDataPrivacyStatementValidation_TBD_OB_004() throws Exception {
        ...
        verifyElementPresent(LoginPage.objPageTitle, getTextVal(LoginPage.objPageTitle, ": Page Title"));
        assertionValidation(getText(LoginPage.objPageTitle), propertyFileReader("TermsAndConditionPageTitle", "onboarding"), ": Page Title");
        ...
        click(LoginPage.objBackBtn, getTextVal(LoginPage.objPageTitle, ": Back Button"));
        ...
        verifyElementPresent(LoginPage.objPageTitle, getTextVal(LoginPage.objPageTitle, ": Page Title"));
        assertionValidation(getText(LoginPage.objPageTitle), propertyFileReader("PrivacyPolicyPageTitle", "onboarding"), ": Page Title");
        ...
        verifyElementPresentAndClick(LoginPage.objBackBtn, getTextVal(LoginPage.objPageTitle, ": Back Button"));
        waitForElementToBePresent(OnBoardingPage.objTermsAndConditionPageTitle,5,"Terms and condition");
        verifyElementPresent(LoginPage.objPageTitle, getTextVal(ContactUsPage.objPageHeader, ": Page Title"));
        assertionValidation(getText(LoginPage.objPageTitle), propertyFileReader("TermsAndConditionPageTitle", "onboarding"), ": Page Title");
        click(OnBoardingPage.objAgreeAndContinueBtn, getTextVal(OnBoardingPage.objAgreeAndContinueBtn, ": Button"));
        ...
        click(OnBoardingPage.objAgreeAndContinueBtn, getTextVal(OnBoardingPage.objAgreeAndContinueBtn, ": Button"));
        waitForElementToBePresent(OnBoardingPage.objEnterOTP,5,"Enter OTP page");
        if(verifyElementPresent(LoginPage.objPageTitle,getTextVal(ContactUsPage.objPageHeader," : Page Title"))){
            assertionValidation(getText(LoginPage.objPageTitle),propertyFileReader("EnterOTP","onboarding"),": Title");
    ...
    public void resendOTPLinkValidation_TBD_OB_006() throws Exception {
        ...
        assertionValidation(getText(LoginPage.objPageTitle),propertyFileReader("EnterOTP","onboarding"),": Title");
        verifyElementPresent(LoginPage.objPageSubTitle,getTextVal(LoginPage.objPageSubTitle,": Page SubTitle"));
        containsValidation(getText(LoginPage.objPageSubTitle),propertyFileReader("EnterOTPPageSubTitle","onboarding"),": Title");
        verifyElementPresentAndClick(OnBoardingPage.objCustomerCareIcon,"Customer care icon");
        contactUsPageUI();
        verifyElementPresentAndClick(LoginPage.objBackBtn,getTextVal(LoginPage.objPageTitle,"back Button"));
    ...
    public void resendOTPMaxAttemptValidation_TBD_OB_007() throws Exception {
        ...
        assertionValidation(getAttributValue("enabled",OnBoardingPage.objResendOTPParentElement),"false",": Enable Attribute value");
    ...
    public void proceedingToNextPageAfterSegmentation1Validation_TBD_OB_020() throws Exception {
        ...
        acceptTermsAndConditionAndPrivacyPolicy();
        verifyElementPresent(LoginPage.objPageTitle,getTextVal(LoginPage.objPageTitle,": Page Title"));
        containsValidation(getText(LoginPage.objPageTitle),propertyFileReader("IDSelectionPage","onboarding"),": Title");
     ...
     * @throws Exception
     */
    public void autoPopulatedPassportDetailsValidation_TBD_OB_022() throws Exception {
        ...
        if(verifyElementPresent(OnBoardingPage.objAutoDetailsPopulatedPageTitle,getTextVal(OnBoardingPage.objAutoDetailsPopulatedPageTitle,": title"))){
            containsValidation(getText(OnBoardingPage.objAutoDetailsPopulatedPageTitle),propertyFileReader("AutoDetailsPopulatedPageTitle","onboarding"),": title");
            verifyElementPresent(OnBoardingPage.objAutoPopulatedFirstName,getTextVal(OnBoardingPage.objAutoPopulatedFirstName,": Auto populated first name"));
            verifyElementPresent(OnBoardingPage.objAutoPopulatedMiddleName,getTextVal(OnBoardingPage.objAutoPopulatedMiddleName,": Auto populated middle name"));
            verifyElementPresent(OnBoardingPage.objAutoPopulatedLastName,getTextVal(OnBoardingPage.objAutoPopulatedLastName,": Auto populated last name"));
            verifyElementPresent(OnBoardingPage.objAutoPopulatedGender,getTextVal(OnBoardingPage.objAutoPopulatedGender,": Auto populated Gender"));
            verifyElementPresent(OnBoardingPage.objAutoPopulatedDateOfBirth,getTextVal(OnBoardingPage.objAutoPopulatedDateOfBirth,": Auto populated Date of  birth"));
    ...
    public void inputOrEditInputGenderFieldValidation_TBD_OB_023() throws Exception {
        ...
        assertionValidation(getText(OnBoardingPage.objAutoPopulatedGender), propertyFileReader("Gender","onboarding"), ": Gender dropdown element");
        if(getText(OnBoardingPage.objAutoPopulatedGender).equals(propertyFileReader("Gender","onboarding"))){
    ...
    public void inputOrEditInputDateOfBirthFieldValidation_TBD_OB_024() throws Exception {
        ...
        containsValidation(getText(OnBoardingPage.objAutoDetailsPopulatedPageTitle),propertyFileReader("AutoDetailsPopulatedPageTitle","onboarding"),": title");
        verifyElementPresent(OnBoardingPage.objAutoPopulatedDateOfBirth,getTextVal(OnBoardingPage.objAutoPopulatedDateOfBirth,": Auto populated Date of  birth"));
        String sAutoPopulatedDateOfBirth = getText(OnBoardingPage.objAutoPopulatedDateOfBirth);
        click(OnBoardingPage.objAutoPopulatedDateOfBirth,getTextVal(OnBoardingPage.objAutoPopulatedDateOfBirth,": Auto populated Date of  birth"));
        ...
        verifyElementPresent(OnBoardingPage.objAutoPopulatedDateOfBirth,getTextVal(OnBoardingPage.objAutoPopulatedDateOfBirth,": Edited Date of  birth"));
        String sUpdatedDateOfBirth = getText(OnBoardingPage.objAutoPopulatedDateOfBirth);
    ...
    /**
     * Method to Verify if the Country of residence will be auto-populated as 'Philippines'
     * @throws Exception
     */
    public void autoPopulatedPhilippinesCountryValidation_TBD_OB_027() throws Exception {
        HeaderChildNode("TBD_OB_027, Onboarding - Verify if the Country of residence will be auto-populated as 'Philippines'");
        enterMobileNumber();
        buttonNeedToTapValidation();
        inputPlaceOfBirthAndContinue();
        ...
        assertionValidation(getText(LoginPage.objPageTitle),propertyFileReader("YourPlaceRightPage","onboarding"),": Title");
        verifyElementPresent(LoginPage.objPageSubTitle,getTextVal(LoginPage.objPageSubTitle,": Page Subtitle"));
        assertionValidation(getText(LoginPage.objPageSubTitle), propertyFileReader("YourPlaceRightSubtitle","onboarding"),": page Subtitle");
        customerCareIconValidation();
        ...
        Swipe("UP",1);
        assertionValidation(getText(LoginPage.objNextBtn),propertyFileReader("NextButton","onboarding"),"Button");
        assertionValidation(getAttributValue("enabled",LoginPage.objNextButton),"false",": Enable Attribute value");
    ...
    public void howToFindYourZipCodeHyperlinkValidation_TBD_OB_028() throws Exception {
        ...
        waitForElementToBePresent(OnBoardingPage.objHowToFindZipCodeLink,5,"Enter OTP page");
        verifyElementPresent(LoginPage.objPageTitle,getTextVal(ContactUsPage.objPageHeader," : Page Title"));
        assertionValidation(getText(LoginPage.objPageTitle),propertyFileReader("YourPlaceRightPage","onboarding"),": Title");
        hideKeyboard();
        waitForElementToBePresent(OnBoardingPage.objHowToFindZipCodeLink,5,"Enter OTP page");
     ...
     * @throws Exception
     */
    public void validZipCodeDetailsValidation_TBD_OB_030() throws Exception {
    ...
    /**
     * Method to Verify if user can click Apply Zip Code to validate
     * @throws Exception
     */
    public void applyZipCodeButtonValidation_TBD_OB_031() throws Exception {
        HeaderChildNode("TBD_OB_031, Onboarding - Verify if user can click Apply Zip Code to validate");
        navigateToZipCode(OnBoardingPage.objPassportOption);
        waitForElementToBePresent(OnBoardingPage.objApplyZipCode,5,"Enter OTP page");
        applyZipCode(propertyFileReader("ValidZipCode","onboarding"));
        if(verifyElementPresent(OnBoardingPage.objProvinceInputField,getTextVal(OnBoardingPage.objProvinceInputField,": Province"))){
    ...
    public void FACTAPageUIValidation_TBD_OB_039() throws Exception {
        ...
        if (verifyElementPresent(OnBoardingPage.objFATCAPageTitle,getTextVal(OnBoardingPage.objFATCAPageTitle,": title"))) {
            assertionValidation(getText(LoginPage.objPageTitle), propertyFileReader("FATCAPageTitle", "onboarding"), ": Title");
            verifyElementPresent(LoginPage.objPageSubTitle, getTextVal(LoginPage.objPageSubTitle, ": Page Subtitle"));
            containsValidation(getText(LoginPage.objPageSubTitle), propertyFileReader("FATCAPageSubtitle", "onboarding"), ": Subtitle");
    ...
    public void inputExistingEmailValidation_TBD_OB_041() throws Exception {
        ...
        verifyElementPresentAndClick(OnBoardingPage.objNextBtn,getTextVal(OnBoardingPage.objNextBtn,": button"));
        updateWhatDoYouDo("Salary","Employed","Accountant/Auditor","Accounting/Bookkeeping");
        selectUSCitizenOrNotAndNext(OnBoardingPage.objNoneOfTheAbove);
        ...
        verifyElementPresentAndClick(OnBoardingPage.objSelectBankingRelationship(propertyFileReader("BankingRelationship","onboarding")), getTextVal(OnBoardingPage.objSelectBankingRelationship(propertyFileReader("BankingRelationship","onboarding")),": Banking Relationship"));
        verifyElementPresentAndClick(OnBoardingPage.objContinueBtn,getTextVal(OnBoardingPage.objContinueBtn,": button"));
        if(verifyElementPresent(LoginPage.objPopupSubHeader,getTextVal(LoginPage.objPopupSubHeader,": Error message"))){
            assertionValidation(getText(LoginPage.objPopupSubHeader),propertyFileReader("InvalidEmailAddress","onboarding"),": error message");
            verifyElementPresentAndClick(LoginPage.objOkBtn,getTextVal(LoginPage.objOkBtn,": button"));
            ...
            String emailAddressAfterEdit = getText(OnBoardingPage.objEmailAddress);
            if(emailAddress.equals(emailAddressAfterEdit)!=true){
     ...
     * @throws Exception
     */
    public void inputInvalidEmailValidation_TBD_OB_043() throws Exception {
        HeaderChildNode("TBD_OB_043, Onboarding - Verify if user can input invalid email address");
        waitForElementToBePresent(OnBoardingPage.objMobileNumberInputField,10,"Mobile number input field");
        type(OnBoardingPage.objMobileNumberInputField, propertyFileReader("ValidMobileNumber", "onboarding"), "Mobile number input field");
        verifyElementPresentAndClick(LoginPage.objNextBtn, getTextVal(OnBoardingPage.objNextBtn, ": Button"));
        waitForElementToBePresent(OnBoardingPage.objButtonToTapBtn,5,"Button to tap");
    ...
    /**
     * Method to Verify if user can leave blank the Email address field Blank
     * @throws Exception
     */
    public void leaveEmailAddressAndCorrespondingErrorValidation_TBD_OB_044() throws Exception {
        HeaderChildNode("TBD_OB_044, Onboarding - Verify if user can leave blank the Email address field Blank");
        waitForElementToBePresent(OnBoardingPage.objMobileNumberInputField,10,"Mobile number input field");
        type(OnBoardingPage.objMobileNumberInputField, propertyFileReader("ValidMobileNumber", "onboarding"), "Mobile number input field");
        verifyElementPresentAndClick(LoginPage.objNextBtn, getTextVal(OnBoardingPage.objNextBtn, ": Button"));
        waitForElementToBePresent(OnBoardingPage.objButtonToTapBtn,5,"Button to tap");
        ...
        click(OnBoardingPage.objEmailAddress,"Email address field");
        click(OnBoardingPage.objMotherMaidenName,"Mother maiden name field");
        verifyElementPresent(LoginPage.objBackBtn,"Email page back button");
    ...
    /**
     * Method to Verify if user can input valid email address
     * @throws Exception
     */
    public void validEmailAddressValidation_TBD_OB_045() throws Exception {
        HeaderChildNode("TBD_OB_045, Onboarding - Verify if user can input valid email address");
        waitForElementToBePresent(OnBoardingPage.objMobileNumberInputField,10,"Mobile number input field");
        type(OnBoardingPage.objMobileNumberInputField, propertyFileReader("ValidMobileNumber", "onboarding"), "Mobile number input field");
        verifyElementPresentAndClick(LoginPage.objNextBtn, getTextVal(OnBoardingPage.objNextBtn, ": Button"));
        waitForElementToBePresent(OnBoardingPage.objButtonToTapBtn,5,"Button to tap");
    ...
    public void validMotherMaidenNameValidation_TBD_OB_046() throws Exception {
        ...
        type(OnBoardingPage.objMotherMaidenName,propertyFileReader("ValidMaidenName","onboarding"),"Mother maiden field");
        String sMotherMaidenName = getText(OnBoardingPage.objMotherMaidenName);
        click(OnBoardingPage.objEmailAddress,"Email address field");
        if(sMotherMaidenName.equals(propertyFileReader("ValidMaidenName","onboarding"))){
     ...
     * @throws Exception
     */
    public void invalidMotherMaidenNameValidation_TBD_OB_047() throws Exception {
    ...
    /**
     * Method to Verify if user can leave blank the Mother's Maiden name field
     * @throws Exception
     */
    public void leaveMotherMaidenNameAndCorrespondingErrorValidation_TBD_OB_048() throws Exception {
        HeaderChildNode("BD_OB_048, Onboarding - Verify if user can leave blank the Mother's Maiden name field");
        waitForElementToBePresent(OnBoardingPage.objMobileNumberInputField,10,"Mobile number input field");
        type(OnBoardingPage.objMobileNumberInputField, propertyFileReader("ValidMobileNumber", "onboarding"), "Mobile number input field");
        verifyElementPresentAndClick(LoginPage.objNextBtn, getTextVal(OnBoardingPage.objNextBtn, ": Button"));
        waitForElementToBePresent(OnBoardingPage.objButtonToTapBtn,5,"Button to tap");
    ...
    public void hereTheDealScreenUIValidation_BD_OB_051() throws Exception {
        ...
        waitForElementToBePresent(OnBoardingPage.objHeresTheDeal,5,"Here's the deal");
        verifyElementPresent(LoginPage.objPageTitle,getTextVal(LoginPage.objPageTitle,": Page Title"));
        containsValidation(getText(LoginPage.objPageTitle),propertyFileReader("HeresTheDeal","onboarding"),": Page Title");
        ...
        if(verifyElementPresent(LoginPage.objHeaderTxt,getTextVal(LoginPage.objHeaderTxt,": title"))){
            assertionValidation(getText(LoginPage.objHeaderTxt),propertyFileReader("CreateAPassword","onboarding"),": title");
    ...
    public void incorrectConfirmPasswordValueValidation_BD_OB_052() throws Exception {
        ...
        verifyElementPresent(LoginPage.objPageTitle, getTextVal(LoginPage.objPageTitle, ": Page Title"));
        verifyElementPresentAndClick(OnBoardingPage.objDeal,getTextVal(OnBoardingPage.objDeal,": button"));
        waitForElementToBePresent(LoginPage.objHeaderTxt,5,"Create password page");
        verifyElementPresent(LoginPage.objHeaderTxt,getTextVal(LoginPage.objHeaderTxt,": title"));
        assertionValidation(getText(LoginPage.objHeaderTxt),propertyFileReader("CreateAPassword","onboarding"),": title");
    ...
    public void createValidPasswordValidation_BD_OB_053_BD_OB_054_BD_OB_056_BD_OB_055() throws Exception {
        ...
        enterMobileNumber();
        waitForElementToBePresent(OnBoardingPage.objLetsSealTheDealPage,10,"Lets Seal the deal");
        verifyElementPresent(LoginPage.objPageTitle,getTextVal(LoginPage.objPageTitle,": title"));
        containsValidation(getText(LoginPage.objPageTitle), propertyFileReader("LetsSealTheDealPage", "onboarding"), ": Title");
        verifyElementPresent(LoginPage.objPageSubTitle,getTextVal(LoginPage.objPageSubTitle,": Page Subtitle"));
        assertionValidation(getText(LoginPage.objPageSubTitle), propertyFileReader("LetsSealTheDealPageSubtitle","onboarding"),": page Subtitle");
    ...
    public void selectSourceOfFundsValidation_BD_OB_035() throws Exception {
        ...
        verifyElementPresent(LoginPage.objPageTitle,getTextVal(LoginPage.objPageTitle,": Page Title"));
        assertionValidation(getText(LoginPage.objPageTitle),propertyFileReader("WhatDoYouDoPageTitle","onboarding"),": Page Title");
        verifyElementPresent(LoginPage.objPageSubTitle,getTextVal(LoginPage.objPageSubTitle," : Page Subtitle"));
        assertionValidation(getText(LoginPage.objPageSubTitle),propertyFileReader("WhatDoYouDoPageSubTitle","onboarding"),": Page Subtitle");
        verifyElementPresentAndClick(OnBoardingPage.objSourceOfFundsInputField,"Source of Funds input field");
        waitForElementToBePresent(OnBoardingPage.objSourceOfFundsPage,10,"Source of funds page");
        verifyElementPresent(LoginPage.objPageTitle,getTextVal(LoginPage.objPageTitle,": Page Title"));
        assertionValidation(getText(LoginPage.objPageTitle),propertyFileReader("SourceOfFundPage","onboarding"),": Page title");
    ...
    public void selectCurrentEmploymentStatusValidation_BD_OB_036() throws Exception {
        ...
        verifyElementPresent(LoginPage.objPageTitle,getTextVal(LoginPage.objPageTitle,": Page Title"));
        assertionValidation(getText(LoginPage.objPageTitle),propertyFileReader("CurrentEmploymentStatusPage","onboarding"),": Page title");
    ...
    public void onboardingNonExistingUserValidation_TBD_OB_058() throws Exception {
        ...
        verifyElementPresent(LoginPage.objPageTitle, getTextVal(LoginPage.objPageTitle, ": Page Title"));
        assertionValidation(getText(LoginPage.objPageTitle), propertyFileReader("VerifyMobileNumberPage","onboarding"),": Page Title");
        verifyElementPresent(LoginPage.objPageSubTitle,getTextVal(LoginPage.objPageSubTitle,": Page Subtitle"));
        assertionValidation(getText(LoginPage.objPageSubTitle), propertyFileReader("VerifyMobileNumberPageSubTitle","onboarding"),": page Subtitle");
    ...
    public void onboardingSKYCWithHighRiskProfile_TBD_OB_064() throws Exception {
        ...
        contactUsPageUI();
        verifyElementPresentAndClick(LoginPage.objBackBtn,"Back btn");
        ...
        if(verifyElementPresent(OnBoardingPage.objExistingTonikCustomerPopup,getTextVal(OnBoardingPage.objExistingTonikCustomerPopup,": popup"))) {
            containsValidation(getText(OnBoardingPage.objExistingTonikCustomerPopup), propertyFileReader("ExistingTonikAccountPopup", "onboarding"), ": popup");
            verifyElementPresentAndClick(LoginPage.objOkBtn, getTextVal(OnBoardingPage.objOkBtn, ": Button"));
        }
        verifyElementPresentAndClick(OnBoardingPage.objLoginHereLink,getTextVal(OnBoardingPage.objLoginHereLink,": link"));
        verifyElementPresentAndClick(OnBoardingPage.objContinueBtn,getTextVal(OnBoardingPage.objContinueBtn,": button"));
        type(OnBoardingPage.objMobileNumberInputField,propertyFileReader("HighRiskProfile","onboarding"),"Mobile number input field");
...
//        handlePopup();
        ...
        verifyElementPresentAndClick(OnBoardingPage.objNextBtn,getTextVal(OnBoardingPage.objNextBtn,": button"));
        updateWhatDoYouDo("Salary","Employed","Accountant/Auditor","Accounting/Bookkeeping");
        selectUSCitizenOrNotAndNext(OnBoardingPage.objAUSACitizen);
        updateEmailMotherNameAndBankingRelationShip();
        updateSignatureAndNext();
        waitForElementToBePresent(OnBoardingPage.objHeresTheDeal,5,"Here's the deal");
        verifyElementPresent(OnBoardingPage.objHeresTheDeal,getTextVal(OnBoardingPage.objHeresTheDeal,": page"));
